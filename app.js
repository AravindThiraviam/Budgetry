...
var UIController = (function() {
    ...
    var formatNumber = function (num, type)  {
        ...
        */
        ...
        int = numSplit[0];
        if (int.length > 3) {
            int = int.substr(0, int.length - 3) + ',' + int.substr(1, 3); // input 34507, output 34,507
        }
    ...
    return {
        ...
        displayMonth: function() {
            ...
            var now = new Date();
            //var Diwali  new Date(2018, 06, 11);
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var sestupEventListeners = function() {
    ...
    return {
        init: function() {
            console.log('Applications has stareted.');
            UICtrl.displayMonth();
